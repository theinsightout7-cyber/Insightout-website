...
export const entities = [
  ...
  },
  {
    ...
    description:
      'We partner with non-profits and community-focused organisations to secure funding, develop scalable interventions, design MEL systems, and strengthen institutional capacity for long-term impact.',
...
export const approach = [
  {
    ...
    description:
      'We begin with a rigorous needs assessment, engaging organisations to understand their priorities, challenges, and operating context. This ensures every solution is grounded in real-world insights.',
    image: '/assets/needs.jpg',
  },
  {
    name: 'Strategic Alignment & Stakeholder Engagement',
    description:
      'We drive strategic alignment by applying sector expertise and activating our network of partners and stakeholders. This creates coherence, shared ownership, and clear pathways for coordinated action.',
    image: '/assets/strategic.jpg',
  },
  {
    name: 'Solution Design & Co-Creation',
    description:
      'Using human-centred design and co-creation methodologies, we develop tailored, context-responsive solutions that are practical, implementable, and aligned with each organisation’s mission',
    image: '/assets/solutions.jpg',
  },
  {
    name: 'Impact Evaluation & Systems Scaling',
    description:
      'We implement robust Monitoring, Evaluation, and Learning (MEL) frameworks to assess outcomes, strengthen decision-making, and support the scaling of successful interventions for long-term impact.',
...
export const newBlogs = [
  {
    id: 1,
    title:
      '5 Key Things to Expect at the Africa Agriculture Dialogue (AAD) 2025, The Agenda Setting Session.',
    date: '2025-10-6',
  ...
  },
  {
    id: 2,
    title:
      'Africa’s Voice in the Global Food Systems Conversation: Reflections from the Africa Agriculture Dialogue 2025.',
    date: '2025-11-03',
    author: 'InsightOut Team',
...
`,
  ...
  },
  {
    id: 4,
    title:
      'Bridging Nigeria’s Primary Healthcare Gap: Identifying the Issues and Laying Down Solutions',
    date: '2025-11-14',
    author: 'InsightOut Team',
    tags: ['Healthcare', 'Nigeria', 'PHC', 'Public Health', 'Development'],
